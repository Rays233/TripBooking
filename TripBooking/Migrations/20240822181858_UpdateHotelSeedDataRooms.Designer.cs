...
namespace TripBooking.Migrations
{
    ...
    [Migration("20240822181858_UpdateHotelSeedDataRooms")]
    partial class UpdateHotelSeedDataRooms
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripBooking.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TripBooking.Models.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Alicante",
                            Country = "Spain",
                            Description = "Antique beachside hotel",
                            Name = "Hotel Valencia"
                        },
                        new
                        {
                            ...
                            City = "Malaga",
                            Country = "Spain",
                            Description = "Modern oasis with vibrant city life nearby",
                            Name = "Hotel Malageuta"
                        },
                        new
                        {
                            HotelId = 3,
                        ...
                        new
                        {
                            ...
                            City = "Marbella",
                            Country = "Spain",
                            Description = "Charming hotel near the Mediterranean.",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TripBooking.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TripBooking.Models.Booking", b =>
                {
                    b.HasOne("TripBooking.Models.Room", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TripBooking.Models.Room", b =>
                {
                    b.HasOne("TripBooking.Models.Hotel", null)
                        .WithMany("Rooms")

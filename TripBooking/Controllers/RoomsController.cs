...
namespace TripBooking.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoomId,HotelId,Type,Price")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoomId,HotelId,Type,Price")] Room room)
        {
            if (id != room.RoomId)
            {
                return NotFound();
